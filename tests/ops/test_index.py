    ...
    def test_custom_region(self):
        ...
        expected = pd.DataFrame(data=(np.ones([20]) * -1),
                                columns=['ENSO Index over POLYGON '
                                         ...
                                         ' -102.65625 6.489983332670652, -90.703125 -3.6888551431470353, -110'
                                         '.21484375 -13.068776734357693, -141.6796875 -6.31529853833002, -141'
                                         '.15234375 3.513421045640057))'],
                                index=expected_time)
        region = str('POLYGON((-141.15234375 3.513421045640057,-129.0234375'
                     ' 6.839169626342807,-102.65625 6.489983332670652,-90.703125 '
