...
rem 3.b. lta:
cate res set cloud_lta long_term_average dsf=@cloud var="cfc"
cate res set soilm_mon temporal_aggregation dsf=@soilm
cate res set soilm_lta long_term_average dsf=@soilm_mon var="sm"

rem 4. Select timeseries:
...
cate res set station_outl detect_outliers dsf=@station var="precipitation" threshold_low=0.00 threshold_high=100.00 quantiles=False

rem 6.b. lta on station-data:
cate res set station_mon temporal_aggregation dsf=@station_outl
cate res set station_lta long_term_average dsf=@station_mon var="precipitation"
 
rem 7. Plot the timeseries of precipitation 
cate res set res_8 plot dsf=@station_outl var="precipitation" file="plot1.jpg"
cate res set res_9 plot dsf=@station_lta var="precipitation" file="plot2.jpg"

rem 8. Plot the timeseries of the ODP datasets
cate res set res_10 plot dsf=@cloud_point var="cfc" file="plot3.jpg"
cate res set res_11 plot dsf=@soilm_point var="sm" file="plot4.jpg"
