...
.. _Essential Climate Variables: https://climate.esa.int/en/odp/#/dashboard
...
In the ESA CCI programme **`Essential Climate Variables`_** (ECVs) are produced by individual expert teams,
