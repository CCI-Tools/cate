...
class SimpleCatalogue(io.Catalogue):
    ...
    def query(self, **constraints) -> Sequence[io.DataSource]:
...
class FileSetDataSourceTest(TestCase):
    ...
    def test_from_json(self):
        self.assertEqual('aerosol/ATSR2_SU/L3/v4.2/DAILY', self.ds0.name)
        ...
        self.assertEqual('aerosol/ATSR2_SU/L3/v4.21/MONTHLY', self.ds1.name)
    ...
    def test_resolve_paths(self):
        paths1 = self.ds0.resolve_paths('2001-01-01', '2001-01-03')
        ...
        paths2 = self.ds0.resolve_paths(datetime(2001, 1, 1), datetime(2001, 1, 3))
        self.assertEqual(paths1, paths2)

    def test_resolve_paths_open_interval(self):
        paths = self.ds0.resolve_paths('2003-06-20')
        ...
        paths = self.ds0.resolve_paths(None, '1995-06-01')
        self.assertIsNotNone(paths)
    ...
    def test_resolve_paths_validaton(self):
        with self.assertRaises(ValueError):
            self.ds0.resolve_paths('2001-01-03', '2001-01-01')

        self.ds0._fileset_info._start_time = None
        with self.assertRaises(ValueError):
            self.ds0.resolve_paths(None, '2001-01-01')

        self.ds0._fileset_info._end_time = None
        with self.assertRaises(ValueError):
            self.ds0.resolve_paths('2001-01-03', None)
