...
@op_input('ds', description='Dataset to filter.')
...
@op_return(description='A filtered dataset')
def filter_dataset(ds: xr.Dataset, variable_names: tuple = None, regex = False, copy: bool = False) -> xr.Dataset:
